...
if (isset($_POST['boton'])) {
    ...
    if ($botonPresionado != Null) {
        ...
        //Obtener datos de la tabla de pacientes de acuerdo al ID que se quiere modificar
                    ...
                    <div class="form-container">
                        <form action="insertar.php" method="post">
                          ...
                          <!--  <label for="fecha">Fecha:</label>
                            ...
                            <p class="Urgencia">
                            <input type="checkbox" id="urgencia" name="urgencia" value="1" <?php echo ($reg['urgencia'] == 1) ? 'checked' : ''; ?>> Urgencia
            ...
            <main>
                ...
                <div class="form-container">
                    <form action="insertar.php" method="post">
                        ...
                        <p class="Urgencia">
                        <input type="checkbox" id="urgencia" name="urgencia" value="1" <?php echo (isset($reg) && $reg['urgencia'] == 1) ? 'checked' : ''; ?>> Urgencia
                        </p>
